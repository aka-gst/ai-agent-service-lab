...
Результат живого запуска зафиксирован в [RESULTS.md](RESULTS.md).
...
Страница читает выбранный CSV в браузере и отправляет содержимое в `/v1/marketplace/chat-upload` без сохранения файла на сервере. API объединяет точный расчёт, RAG и объяснение Ollama. Поддерживаются вопросы о проценте выкупа и возвратах. Ограничение запроса — 5 МБ.
