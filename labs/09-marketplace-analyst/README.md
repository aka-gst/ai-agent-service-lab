...
Для сравнения периодов выберите текущий и предыдущий CSV. Страница вызовет `/v1/marketplace/compare-upload`, рассчитает изменение выкупа в процентных пунктах и выделит товары со снижением.
